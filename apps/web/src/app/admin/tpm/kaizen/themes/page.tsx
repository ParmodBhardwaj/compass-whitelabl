...
/**
 * /admin/tpm/kaizen/themes — auto-generated portal admin page.
 * Edit via tools/gen-admin-pages.mjs to keep config consistent.
 */
export default function ThemeAdminPage() {
  return (
    <MasterDataPanel<Theme>
      title="TPM — KaiZen Themes"
      entityName="Theme"
      ...
      columns={[
        ...
        { header: 'Theme Name', cell: (r) => <span style={{ fontWeight: 600 }}>{r.name}</span> },
