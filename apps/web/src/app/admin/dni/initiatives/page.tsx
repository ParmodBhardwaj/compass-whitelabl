...
/**
 * /admin/dni/initiatives — auto-generated portal admin page.
 * Edit via tools/gen-admin-pages.mjs to keep config consistent.
 */
export default function InitiativeAdminPage() {
  return (
    <MasterDataPanel<Initiative>
      title="D&I — Initiatives"
      entityName="Initiative"
      breadcrumb={[{'label':'Home','href':'/admin'},{'label':'D&I'},{'label':'Initiatives'}]}
      apiPath="/dni/initiatives"
      blank={{'name':'','shortDescription':'','description':'','image':'','sortOrder':0,'status':'1','isFeatured':'0'}}
      searchableKeys={["name","shortDescription"]}
      columns={[
        { header: 'Id', width: 60, cell: (r) => r.id },
        { header: 'Title', cell: (r) => <span style={{ fontWeight: 600 }}>{r.name}</span> },
