...
/**
 * /admin/dni/newsletters — auto-generated portal admin page.
 * Edit via tools/gen-admin-pages.mjs to keep config consistent.
 */
export default function NewsletterAdminPage() {
  return (
    <MasterDataPanel<Newsletter>
      title="D&I — Newsletters"
      entityName="Newsletter"
      breadcrumb={[{'label':'Home','href':'/admin'},{'label':'D&I'},{'label':'Newsletters'}]}
      apiPath="/dni/newsletters"
